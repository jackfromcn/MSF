...
angular.module('xdiamondApp').controller("GroupController", ['$scope', 'groups', 'GroupService', '$modal', '$state',
    function ($scope, groups, GroupService, $modal, $state) {
        ...
        $scope.popUpdateGroupModal = function (group, size) {
...
angular.module('xdiamondApp').controller("GroupUpdateController",
    ['$scope', '$state', '$modal', '$modalInstance', 'GroupService', 'group',
        function ($scope, $state, $modal, $modalInstance, GroupService, group) {
            $scope.group = group;

            $scope.update = function () {
                GroupService.patch(group).then(function () {
                    $state.reload();
                })
                $modalInstance.close();
            }
