package com.msf.fuxi.xdiamond.client.spring;
			...
			if (methods != null) {
				for (Method method : methods) {
					...
					if (oneKeyListener != null) {
						...
						wrapper.setListenerClassName(com.msf.fuxi.xdiamond.client.event.OneKeyListener.class.getName());
					...
					if (allKeyListener != null) {
						ObjectListenerMethodInvokeWrapper wrapper = new ObjectListenerMethodInvokeWrapper();
						wrapper.setxDiamondConfig(xDiamondConfig);
						wrapper.setListenerClassName(com.msf.fuxi.xdiamond.client.event.AllKeyListener.class.getName());
						wrapper.setTargetObject(bean);
						wrapper.setTargetMethod(method.getName());
						wrapper.init();
					}
