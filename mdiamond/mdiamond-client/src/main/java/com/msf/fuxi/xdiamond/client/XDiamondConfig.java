package com.msf.fuxi.xdiamond.client;

import com.alibaba.fastjson.JSON;
import com.msf.fuxi.xdiamond.client.event.AllKeyListener;
...
import com.msf.fuxi.xdiamond.client.net.XDiamondClient;
import com.msf.fuxi.xdiamond.common.ResolvedConfigVO;
import com.msf.fuxi.xdiamond.common.util.ThreadFactoryBuilder;
...
public class XDiamondConfig {
  ...
  static class GetConfigTask extends TimerTask {
    ...
    public void run() {
      ...
      try {
        ...
        logger.warn("timer to get xdiamond config error!", e);
      }
    }
  }
  ...
  private String toProjectInfoString() {
    return this.groupId + "|" + artifactId + "|" + version + "|" + profile + "|" + secretKey;
  }
}
